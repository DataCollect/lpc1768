...
typedef struct
{
  ...
  uint32_t          reg_addr;                   /* device register addr */
  uint32_t          reg_addr_byte_nbr;          /* bytes of device register addr*/
  __IO uint32_t     send_opt_type;              /* 0:send data ; 1: read data ,send addr 2: send data ,send addr */
